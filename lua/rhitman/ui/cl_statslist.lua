...
function PANEL:UpdateStats()
    ...
    self:CreateStatRow(cStats, "Money Spent", rHitman.Util.formatCurrency(stats.contractor.moneySpent or 0), rHitman.UI.Colors.Primary)
    ...
    self:CreateStatRow(hStats, "Money Earned", rHitman.Util.formatCurrency(stats.hitman.moneyEarned or 0), rHitman.UI.Colors.Primary)
